...
#python test.py dataset=SMD_machine-2-1 window_size=100 stride=1 eval_stride=1 batch_size=1 eval_batch_size=1 normalization=None model=THOC infer_options=["offline_all"] +qStart=0.90 +qEnd=1.00 +qStep=0.01
