...
python test.py dataset=SMD_machine-2-1 window_size=5 stride=5 eval_stride=5 batch_size=8 eval_batch_size=8 log_freq=1 model=LSTMEncDec scaler=std normalization=None infer_options=["offline_all"] +qStart=0.90 +qEnd=1.00 +qStep=0.01
