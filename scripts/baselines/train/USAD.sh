...
python train.py dataset=SMD_machine-2-1 window_size=5 stride=5 eval_stride=5 batch_size=8 eval_batch_size=8 epochs=30 scaler=minmax model=USAD scaler=minmax normalization=None model.latent_dim=38
