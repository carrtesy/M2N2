...
python train.py dataset=MSL_P-15 window_size=5 stride=5 eval_stride=5 batch_size=2 eval_batch_size=2 model=LSTMEncDec scaler=std normalization=None
python train.py dataset=yahoo_20 window_size=5 stride=5 eval_stride=5 batch_size=2 eval_batch_size=2 model=LSTMEncDec scaler=std normalization=None
python train.py dataset=SMD_machine-1-4 window_size=5 stride=5 eval_stride=5 log_freq=3 batch_size=2 eval_batch_size=2 model=LSTMEncDec scaler=std normalization=None